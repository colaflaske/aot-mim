if (window.location.pathname == '/game/merchant') {
  var MIMObj = {
    ...
    htmlContent: {
      card: '<div class="card"> <div class="card-header">Merchant Improvement Mod </div><div id="mod-settings-body" class="card-body"> <div id="mim-total-inventory-value"> </div><div class="form-check"> <label class="form-check-label" for="mim-persist-sell-btn">Hide default sell button <input class="form-check-input" type="checkbox" value="" id="mim-persist-sell-btn"> </label> </div><div class="form-check"> <label class="form-check-label" for="mim-show-sell-value">Show sell value <input class="form-check-input" type="checkbox" value="" id="mim-show-sell-value"> </label> </div><div class="form-check"> <label class="form-check-label" for="mim-hide-null-items">Hide items you don\'t currently have <input class="form-check-input" type="checkbox" value="" id="mim-hide-null-items"> </label> </div><div class="form-check"> <label class="form-check-label" for="mim-half-btn-enabled">Show sell half button <input class="form-check-input" type="checkbox" value="" id="mim-half-btn-enabled"> </label> </div><div class="form-check"> <label class="form-check-label" for="mim-max-btn-enabled">Show sell max button <input class="form-check-input" type="checkbox" value="" id="mim-max-btn-enabled"> </label> </div><br/><button type="button" id="mim-settings-save-btn" class="btn btn-primary btn-block">Save settings</button></div></div>',
    }
  };
